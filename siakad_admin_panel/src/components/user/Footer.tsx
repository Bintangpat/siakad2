...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-surface-container-low dark:bg-surface-container-lowest border-t border-outline-variant dark:border-outline mt-12">
      <div className="flex flex-col md:flex-row justify-between items-center w-full px-6 md:px-10 py-6 max-w-7xl mx-auto gap-4">
        <div className="flex flex-col items-center md:items-start gap-1">
          <span className="text-sm font-semibold text-secondary dark:text-secondary-fixed-dim">
            SIAKAD University
          </span>
          <p className="text-xs text-on-surface-variant dark:text-surface-variant text-center md:text-left">
